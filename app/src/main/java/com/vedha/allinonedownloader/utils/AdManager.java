...
public class AdManager {
    ...
    public AdManager(Activity activity) {
        ...
        rewardedAd = new RewardedAd(activity, "ca-app-pub-1838677544163695/5332208370");
        loadRewardedAd();
    }
    ...
    public static void showInterAd(final Activity context, final Intent intent) {
        if (adCounter == 7 && mInterstitialAd != null) {
            adCounter = 1;
...
//            mInterstitialAd.show((Activity) context);
    ...
    public static void showMaxInterstitial(final Activity context, final Intent intent) {
        maxIntent = intent;
        if (adCounter == 7 && maxInterstitialAd != null && maxInterstitialAd.isReady()) {
            adCounter = 1;
